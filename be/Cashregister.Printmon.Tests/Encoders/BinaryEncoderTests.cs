...
public sealed class BinaryEncoderTests
{
    ...
    public void Encode_AutoInitOnly_ProducesEscAtBytes()
    {
        ...
        Assert.Equal([0x1B, 0x40, 0x1B, 0x74, 0x00, 0x0A, 0x1D, 0x56, 0x42, 0x01], result.Value);
    }
    ...
    public void Encode_UseFontB_NoFlags_ProducesCorrectBytes()
    {
        ...
        Assert.True(result.Ok);
        Assert.Equal([0x1B, 0x40, 0x1B, 0x74, 0x00, 0x1B, 0x21, 0x01, 0x0A, 0x1D, 0x56, 0x42, 0x01], result.Value);
    }
    ...
    public void Encode_UseFontA_WithEmphasizedAndDoubleHeight_ProducesCorrectBitmask()
    {
        ...
        Assert.True(result.Ok);
        Assert.Equal([0x1B, 0x40, 0x1B, 0x74, 0x00, 0x1B, 0x21, 0x18, 0x0A, 0x1D, 0x56, 0x42, 0x01], result.Value);
    }
    ...
    public void Encode_UseFontB_WithAllFlags_ProducesCorrectBitmask()
    {
        ...
        Assert.True(result.Ok);
        Assert.Equal([0x1B, 0x40, 0x1B, 0x74, 0x00, 0x1B, 0x21, 0xB9, 0x0A, 0x1D, 0x56, 0x42, 0x01], result.Value);
    }
    ...
    public void Encode_UnderlineOff_ProducesCorrectBytes()
    {
        ...
        Assert.True(result.Ok);
        Assert.Equal([0x1B, 0x40, 0x1B, 0x74, 0x00, 0x1B, 0x2D, 0x00, 0x0A, 0x1D, 0x56, 0x42, 0x01], result.Value);
    }
    ...
    public void Encode_UnderlineOnOneDot_ProducesCorrectBytes()
    {
        ...
        Assert.True(result.Ok);
        Assert.Equal([0x1B, 0x40, 0x1B, 0x74, 0x00, 0x1B, 0x2D, 0x01, 0x0A, 0x1D, 0x56, 0x42, 0x01], result.Value);
    }
    ...
    public void Encode_UnderlineOnTwoDots_ProducesCorrectBytes()
    {
        ...
        Assert.True(result.Ok);
        Assert.Equal([0x1B, 0x40, 0x1B, 0x74, 0x00, 0x1B, 0x2D, 0x02, 0x0A, 0x1D, 0x56, 0x42, 0x01], result.Value);
    }
    ...
    public void Encode_EmphasizeOn_ProducesCorrectBytes()
    {
        ...
        Assert.True(result.Ok);
        Assert.Equal([0x1B, 0x40, 0x1B, 0x74, 0x00, 0x1B, 0x45, 0x01, 0x0A, 0x1D, 0x56, 0x42, 0x01], result.Value);
    }
    ...
    public void Encode_EmphasizeOff_ProducesCorrectBytes()
    {
        ...
        Assert.True(result.Ok);
        Assert.Equal([0x1B, 0x40, 0x1B, 0x74, 0x00, 0x1B, 0x45, 0x00, 0x0A, 0x1D, 0x56, 0x42, 0x01], result.Value);
    }
    ...
    public void Encode_DoubleStrikeOn_ProducesCorrectBytes()
    {
        ...
        Assert.True(result.Ok);
        Assert.Equal([0x1B, 0x40, 0x1B, 0x74, 0x00, 0x1B, 0x47, 0x01, 0x0A, 0x1D, 0x56, 0x42, 0x01], result.Value);
    }
    ...
    public void Encode_DoubleStrikeOff_ProducesCorrectBytes()
    {
        ...
        Assert.True(result.Ok);
        Assert.Equal([0x1B, 0x40, 0x1B, 0x74, 0x00, 0x1B, 0x47, 0x00, 0x0A, 0x1D, 0x56, 0x42, 0x01], result.Value);
    }
    ...
    public void Encode_SelectFontA_ProducesCorrectBytes()
    {
        ...
        Assert.True(result.Ok);
        Assert.Equal([0x1B, 0x40, 0x1B, 0x74, 0x00, 0x1B, 0x4D, 0x00, 0x0A, 0x1D, 0x56, 0x42, 0x01], result.Value);
    }
    ...
    public void Encode_SelectFontB_ProducesCorrectBytes()
    {
        ...
        Assert.True(result.Ok);
        Assert.Equal([0x1B, 0x40, 0x1B, 0x74, 0x00, 0x1B, 0x4D, 0x01, 0x0A, 0x1D, 0x56, 0x42, 0x01], result.Value);
    }
    ...
    public void Encode_NinetyDegsOn_ProducesCorrectBytes()
    {
        ...
        Assert.True(result.Ok);
        Assert.Equal([0x1B, 0x40, 0x1B, 0x74, 0x00, 0x1B, 0x56, 0x01, 0x0A, 0x1D, 0x56, 0x42, 0x01], result.Value);
    }
    ...
    public void Encode_NinetyDegsOff_ProducesCorrectBytes()
    {
        ...
        Assert.True(result.Ok);
        Assert.Equal([0x1B, 0x40, 0x1B, 0x74, 0x00, 0x1B, 0x56, 0x00, 0x0A, 0x1D, 0x56, 0x42, 0x01], result.Value);
    }
    ...
    public void Encode_UpsideDownOn_ProducesCorrectBytes()
    {
        ...
        Assert.True(result.Ok);
        Assert.Equal([0x1B, 0x40, 0x1B, 0x74, 0x00, 0x1B, 0x7B, 0x01, 0x0A, 0x1D, 0x56, 0x42, 0x01], result.Value);
    }
    ...
    public void Encode_UpsideDownOff_ProducesCorrectBytes()
    {
        ...
        Assert.True(result.Ok);
        Assert.Equal([0x1B, 0x40, 0x1B, 0x74, 0x00, 0x1B, 0x7B, 0x00, 0x0A, 0x1D, 0x56, 0x42, 0x01], result.Value);
    }
    ...
    public void Encode_FontSize_NormalSize_ProducesCorrectBytes()
    {
        ...
        Assert.True(result.Ok);
        Assert.Equal([0x1B, 0x40, 0x1B, 0x74, 0x00, 0x1D, 0x21, 0x00, 0x0A, 0x1D, 0x56, 0x42, 0x01], result.Value);
    }
    ...
    public void Encode_FontSize_DoubleWidthAndHeight_ProducesCorrectBytes()
    {
        ...
        Assert.True(result.Ok);
        Assert.Equal([0x1B, 0x40, 0x1B, 0x74, 0x00, 0x1D, 0x21, 0x11, 0x0A, 0x1D, 0x56, 0x42, 0x01], result.Value);
    }
    ...
    public void Encode_JustifyLeft_ProducesCorrectBytes()
    {
        ...
        Assert.True(result.Ok);
        Assert.Equal([0x1B, 0x40, 0x1B, 0x74, 0x00, 0x1B, 0x61, 0x00, 0x0A, 0x1D, 0x56, 0x42, 0x01], result.Value);
    }
    ...
    public void Encode_JustifyCenter_ProducesCorrectBytes()
    {
        ...
        Assert.True(result.Ok);
        Assert.Equal([0x1B, 0x40, 0x1B, 0x74, 0x00, 0x1B, 0x61, 0x01, 0x0A, 0x1D, 0x56, 0x42, 0x01], result.Value);
    }
    ...
    public void Encode_JustifyRight_ProducesCorrectBytes()
    {
        ...
        Assert.True(result.Ok);
        Assert.Equal([0x1B, 0x40, 0x1B, 0x74, 0x00, 0x1B, 0x61, 0x02, 0x0A, 0x1D, 0x56, 0x42, 0x01], result.Value);
    }
    ...
    public void Encode_AbsolutePosition_ProducesCorrectBytes()
    {
        ...
        Assert.True(result.Ok);
        Assert.Equal([0x1B, 0x40, 0x1B, 0x74, 0x00, 0x1B, 0x24, 0x04, 0x01, 0x0A, 0x1D, 0x56, 0x42, 0x01], result.Value);
    }
    ...
    public void Encode_AbsolutePosition_Zero_ProducesCorrectBytes()
    {
        ...
        Assert.True(result.Ok);
        Assert.Equal([0x1B, 0x40, 0x1B, 0x74, 0x00, 0x1B, 0x24, 0x00, 0x00, 0x0A, 0x1D, 0x56, 0x42, 0x01], result.Value);
    }
    ...
    public void Encode_RelativePosition_ProducesCorrectBytes()
    {
        ...
        Assert.True(result.Ok);
        Assert.Equal([0x1B, 0x40, 0x1B, 0x74, 0x00, 0x1B, 0x5C, 0x04, 0x03, 0x0A, 0x1D, 0x56, 0x42, 0x01], result.Value);
    }
    ...
    public void Encode_LeftMargin_ProducesCorrectBytes()
    {
        ...
        Assert.True(result.Ok);
        Assert.Equal([0x1B, 0x40, 0x1B, 0x74, 0x00, 0x1D, 0x4C, 0x00, 0x02, 0x0A, 0x1D, 0x56, 0x42, 0x01], result.Value);
    }
    ...
    public void Encode_Text_ProducesAsciiBytes()
    {
        ...
        Assert.True(result.Ok);
        Assert.Equal([0x1B, 0x40, 0x1B, 0x74, 0x00, 0x48, 0x69, 0x0A, 0x1D, 0x56, 0x42, 0x01], result.Value);
    }
    ...
    public void Encode_HorizontalTab_ProducesCorrectBytes()
    {
        ...
        Assert.True(result.Ok);
        Assert.Equal([0x1B, 0x40, 0x1B, 0x74, 0x00, 0x09, 0x0A, 0x1D, 0x56, 0x42, 0x01], result.Value);
    }
    ...
    public void Encode_LineFeed_ProducesCorrectBytes()
    {
        ...
        Assert.True(result.Ok);
        Assert.Equal([0x1B, 0x40, 0x1B, 0x74, 0x00, 0x0A, 0x0A, 0x1D, 0x56, 0x42, 0x01], result.Value);
    }
    ...
    public void Encode_PrintLine_ProducesTextThenLineFeedBytes()
    {
        ...
        Assert.True(result.Ok);
        Assert.Equal([0x1B, 0x40, 0x1B, 0x74, 0x00, 0x48, 0x69, 0x0A, 0x0A, 0x1D, 0x56, 0x42, 0x01], result.Value);
    }
    ...
    public void Encode_CutAfter_WithCustomDistance_ProducesCorrectBytes()
    {
        ...
        Assert.True(result.Ok);
        Assert.Equal([0x1B, 0x40, 0x1B, 0x74, 0x00, 0x1D, 0x56, 0x42, 0x32, 0x0A, 0x1D, 0x56, 0x42, 0x01], result.Value);
    }
}